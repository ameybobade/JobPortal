...
export default function RegistrationForm() {
    ...
    const handleSubmit = (event) => {
        ...
        //     })
            axios
            .post(`https://karyam-test-jp.herokuapp.com/applicant`,postData)
            .then(response => {
                        ...
                        <fieldset className="border rounded p-3">
                            ...
                            <div className="row">
                                <div className="col-12 col-md-4 col-sm-12 mt-3">
                                    <TextField id="outlined-basic" label="Name" fullWidth variant="outlined" value={name} onChange={handleNameChange}/>
                                </div>
                                <div className="col-12 col-md-4 col-sm-12 mt-3">
